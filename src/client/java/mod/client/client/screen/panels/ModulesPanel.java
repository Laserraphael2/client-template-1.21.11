...
public class ModulesPanel implements ScreenPanel {
    private final XenonMenuScreen screen;

    public ModulesPanel(XenonMenuScreen screen) {
        this.screen = screen;
    }

    @Override
    public void render(GuiGraphics ctx, int mouseX, int mouseY, int winX, int winY, XenonTheme theme) {
        screen.renderModulesPanel(ctx, mouseX, mouseY, winX, winY, theme);
    }
    ...
    public boolean mouseClicked(double mx, double my, int button) {
        ...
        return screen.handleModulesPanelClick((int) mx, (int) my);
    }
}
